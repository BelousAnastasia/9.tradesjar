...
(function($) {
    ...
    $('body').on('click', '#home-video-id', function (e) {
        // video tag element
        var video_tag = $('#home-video-id');
        // video tag element

        $(video_tag).append('<source src="images/tradingjar.mp4" type="video/mp4">');
        $(video_tag).trigger('play');
    });
